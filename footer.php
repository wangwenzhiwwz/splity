...
Copyright © 2019 <?php $this->options->icp(); ?>. <?php _e( '建站日期:' ); ?><?php $this->options->sitedate(); ?>&nbsp;<?php $this->options->zztj(); ?>.         		</div>
</div>
<div class="flex-md-fill"></div>
<div class="mt-3 mt-md-0">

<?php if ($this->options->wechat): ?>
<a href="javascript:" data-img="<?php $this->options->wechat(); ?>" data-title="<?php $this->author->screenName(); ?>的微信号" data-desc="微信扫一扫，立即关注" class="single-popup btn btn-secondary btn-weixin btn-icon">
...
<script type="text/javascript" src="<?php $this->options->themeUrl('js/theia-sticky-sidebar.min.js?ver=1.0.2'); ?>"></script>
