...
<span class="mx-1"><i class="text-md iconfont icon-eye-line mx-1"></i><small><?php Postviews($this); ?></small></span>
<a class="mx-1" href="#comments"><i class="text-md iconfont icon-chat--line mx-1"></i><small><a href="<?php $this->permalink() ?>#comments"><?php $this->commentsNum('0', '1', '%d'); ?></a></small></a> 
</div>
</div>
...
<a href="<?php $relatedPosts->permalink(); ?>" target="_blank" class="list-title h-2x">
...
<div id="comments" class="comments">
		<div class="mx-1 my-3">
			...
			评论 <small class="font-theme text-muted">(<?php $this->commentsNum(_t('暂无评论'), _t('1'), _t('%d')); ?>)</small>		</div>
		<div class="card">
